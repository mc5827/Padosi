<?php
	...
	try {
		...
		$stmt= $dbh->prepare('select userName from registeredUser where block=? and hood=? and approvalStatus="pending" ;');
		...
		foreach ($results as $rows){
			$newNeighbours[$counter++] = $rows['userName'];
		}

		echo json_encode($newNeighbours);
